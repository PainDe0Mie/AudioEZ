...
from PySide6.QtWidgets import QProgressBar, QTextEdit, QDialog, QVBoxLayout, QLabel, QPushButton
...
class VerificationThread(QThread):
    ...
    verification_complete = Signal(bool, str)
    task_progress_update = Signal(int, int)
